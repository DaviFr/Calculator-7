...
class CauculadoraComum(object):
	def __init__(self):
		...
		ButaoDeletar = Button(self.Janela, text= "⌫", font= "Arial, 16", bg= "blue", activebackground= "dark blue", fg= "white", activeforeground= "grey", width= 3, borderwidth= '3', cursor= "dotbox", justify= LEFT, height= 2, command= self.Deletar)
		ButaoDeletar.place(x= 360, y= 70)
